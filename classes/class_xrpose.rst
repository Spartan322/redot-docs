...
.. XML source: https://github.com/Redot-Engine/redot-engine/tree/4.3/doc/classes/XRPose.xml.
...
The name of this pose. Pose names are often driven by an action map setup by the user. Redot does suggest a number of pose names that it expects :ref:`XRInterface<class_XRInterface>`\ s to implement:
